...
<body>
    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a href="<?php $link = 'contact-form.php'; $current_page = true; echo $link; ?>"<?php if($current_page) echo ' class="selected_menu"'; ?>>Обратная связь</a></li>
    ...
    <div class="contact-form">
        ...
        <form action="https://httpbin.org/post" method="POST" enctype="multipart/form-data">
            ...
            <input type="text" maxlength="25" size="40" name="name">

            <p><strong>Email:</strong></p>
            <input type="email" id="email" name="email" required>

            <p><strong>Откуда узнали о нас:</strong></p>
            <div class="radio-group">
                <p><input type="radio" name="source" value="интернет"> Интернет</p>
                <p><input type="radio" name="source" value="реклама"> Реклама</p>
                <p><input type="radio" name="source" value="друзья"> Друзья</p>
            </div>

            <p><strong>Тип обращения:</strong></p>
            <select id="type" name="type">
                <option disabled>Выберите тип обращения</option>
                <option value="жалоба">Жалоба</option>
                <option selected value="предложение">Предложение</option>
            </select>

            <p><strong>Текст сообщения:</strong></p>
            <textarea name="сообщение" cols="40"  rows="3"></textarea>

            <p><strong>Вложения:</strong></p>
            <input type="file" name="file">

            <p><input type="checkbox" name="согласие">Даю согласие на обработку персональных данных</p>
